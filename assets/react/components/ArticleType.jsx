...
export default function ArticleType({data}) {
       ...
       <form className="space-y-4" action="#">
            <div class="grid gap-4 mb-4 grid-cols-2">
                ...
                <div class="col-span-2">
                    <label htmlFor="article_content" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Contenu</label>
