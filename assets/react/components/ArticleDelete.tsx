...
export default function ArticleDelete({article, handleCancel, handleConfirm}: ArticleDeleteProps): React.JSX.Element {

    const open = null !== article;
        ...
        <div className={overlayClassName()} tabIndex={-1} role="dialog">           
            <div className={ dialogClassName() } role="document">
                <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600 border-gray-200">
                    ...
                    <button type="button" onClick={handleCancel} className="end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="authentication-modal">
                ...
                <div className="p-4 md:p-5">
                    ...
                    <p>{`Est-vous sûr de voiloir supprimer l'article ${article?.title} ?`}</p>
