...
type ComponentKey = 'login' | 'article';

interface ModalComponentProps {
  data: unknown;
}

const Components: Record<ComponentKey, React.ComponentType<ModalComponentProps>> = {
  login: Login,
  article: Article,
};
...
export default function Modal(): React.JSX.Element {
    ...
    const ModalContent = () => {
        if (component) {
            return React.createElement(Components[component as unknown as ComponentKey], {
                data: data,
            });
        }
    }
