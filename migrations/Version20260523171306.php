...
final class Version20260523171306 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE level ADD type_int INT NOT NULL');
    }

    public function postDown(Schema $schema): void
    {
        foreach($this->getTypes() as $type) {
            $this->connection->executeQuery('UPDATE level SET type_int=:type WHERE type=:enum', $type);
        }
        $this->connection->executeQuery('ALTER TABLE level DROP type');
        $this->connection->executeQuery('ALTER TABLE level CHANGE type_int type INT NOT NULL');
    }
