 ...
 */
final class Version20220701184314 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE background (id INT AUTO_INCREMENT NOT NULL, filename VARCHAR(255) NOT NULL, landscape_position LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', square_position LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', portrait_position LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
