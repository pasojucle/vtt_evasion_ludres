...
final class Version20220319071122 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE content ADD filename VARCHAR(255) DEFAULT NULL, ADD url VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE content DROP filename, DROP url');
    }
}
