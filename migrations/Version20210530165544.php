 ...
 */
final class Version20210530165544 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE registration_step_content (id INT AUTO_INCREMENT NOT NULL, registration_step_id INT NOT NULL, content LONGTEXT NOT NULL, form_children INT DEFAULT NULL, INDEX IDX_E8C66E8233C34B3A (registration_step_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
