...
final class Version20221016160933 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        if (false !== $parameterGroupId) {
            ...
            $parameter = [
                'content' => '<p>Afin de permettre l&rsquo;accueil d&rsquo;un plus grand nombre de jeunes dans les clubs, la F&eacute;d&eacute;ration fran&ccedil;aise de cyclotourisme a cr&eacute;&eacute; le statut &laquo; d&rsquo;adulte accompagnateur &raquo;. Ce dispositif est un moyen pour inciter la personne &agrave; s&rsquo;engager dans le processus de formation f&eacute;d&eacute;rale (animateur &ndash; initiateur &ndash; moniteur). Une demande de contr&ocirc;le de l&rsquo;honorabilit&eacute; sera demand&eacute;e aux services de l&rsquo;Etat.<br /><strong>Conditions :</strong></p><ul><li>&Ecirc;tre licenci&eacute;.e au club ;</li><li>Pratiquer r&eacute;guli&egrave;rement l&rsquo;activit&eacute; route / VTT ;</li><li>&Ecirc;tre motiv&eacute;.e par l&rsquo;encadrement des activit&eacute;s jeunes.</li></ul><p><strong>Comp&eacute;tences :</strong></p><ul><li>&Ecirc;tre attentif.ve au comportement des jeunes ;</li><li>&Ecirc;tre capable de v&eacute;rifier le v&eacute;lo avant de partir en randonn&eacute;e ;</li><li>&Ecirc;tre capable de transmettre les consignes de s&eacute;curit&eacute; en randonn&eacute;e.</li></ul><p><strong>Comportement attendu :</strong></p><ul><li>Accompagner le groupe avec vigilance ;</li><li>Avoir un comportement irr&eacute;prochable (respect des r&egrave;gles, des jeunes et des consignes) ;</li><li>Veiller au partage de l&rsquo;espace (route et chemins) ;</li><li>Utiliser un v&eacute;lo conforme aux prescriptions du Code de la route ;</li><li>Porter un casque r&eacute;glementaire.</li></ul><p><strong>D&eacute;roulement des activit&eacute;s :</strong></p><ul><li>L&rsquo;adulte accompagnateur.trice applique les consignes dict&eacute;es par l&rsquo;animateur, l&#39;&eacute;ducateur ou le pr&eacute;sident de club (horaires, d&eacute;roulement de la sortie, exercices, s&eacute;curit&eacute;, etc.).</li></ul><p>L&rsquo;attestation est d&eacute;livr&eacute;e pour la saison {{ full_saison }} par le pr&eacute;sident du club apr&egrave;s avis du responsable des &eacute;ducateurs le cas &eacute;ch&eacute;ant.</p><p>&nbsp;</p><p>Syvain Kohler, Pr&eacute;sident du club VTT &Eacute;vasion Ludres N&deg; f&eacute;d&eacute;ral 07220</p><p><strong>Atteste que</strong></p><p>{{ prenom_nom }}</p><p>N&eacute;(e) le {{ date_naissance }} &agrave; {{ lieu_naissance }}</p><p>Licenci&eacute;.e au club VTT &Eacute;vasion Ludres - Num&eacute;ro de licence {{ numero_licence }}</p><p>Remplit les conditions pour &ecirc;tre &laquo; adulte accompagnateur.trice &raquo; et participer sous la responsabilit&eacute; d&rsquo;un animateur, d&#39;un &eacute;ducateur qualifi&eacute; (initiateur, moniteur, instructeur) ou du pr&eacute;sident du club le cas &eacute;ch&eacute;ant, &agrave; l&rsquo;encadrement des jeunes.</p><p>&nbsp;</p><p>Cette fonction donne acc&egrave;s &agrave; une certaine partie d&rsquo;informations utiles &agrave; l&rsquo;organisation de nos s&eacute;ances d&rsquo;&eacute;cole cyclo. <strong>{{ prenom_nom }} </strong>s&rsquo;engage &agrave; ne pas utiliser ou divulguer ces informations en dehors de toute activit&eacute; li&eacute;e &agrave; cette organisation.</p><p>&nbsp;</p><p>Fait &agrave; Ludres le {{ date }}</p><p>Signatures pr&eacute;c&eacute;d&eacute;es de la mention &quot;Lu et approuv&eacute;&quot;</p><table border="0" cellpadding="0" cellspacing="0" style="width:100%"><tbody><tr><td style="text-align:center; width:30%"><strong>Le pr&eacute;sident</strong></td><td style="text-align:center">&nbsp;</td><td style="text-align:center; width:30%"><strong>L&rsquo;&eacute;ducateur<br />de la structure jeunes</strong></td><td style="text-align:center">&nbsp;</td><td style="text-align:center; width:30%"><strong>L&rsquo;int&eacute;ress&eacute;</strong></td></tr><tr><td style="border-color:#aaaaaa; border-width:2px; height:80px; text-align:center">&nbsp;</td><td style="text-align:center">&nbsp;</td><td style="border-color:#aaaaaa; border-width:2px; text-align:center">&nbsp;</td><td style="text-align:center">&nbsp;</td><td style="border-color:#aaaaaa; border-width:2px; text-align:center">&nbsp;</td></tr></tbody></table><p>&nbsp;</p>',
