...
final class Version20231106195220 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $registrationSteps = [
            [9, 'Téléchargement final', NULL, 7, 0, '<p style="text-align:center"><strong>VOTRE DOSSIER D&#39;INSCRIPTION VOUS A &Eacute;T&Eacute; ENVOY&Eacute; PAR MAIL &Agrave; L&#39;ADRESSE<span style="font-size:18px"> </span>{{ email_principal }}.</strong></p><p style="text-align:center"><span style="font-family:Arial,Helvetica,sans-serif">Imprimez&nbsp;le fichier <strong>&quot;Docs_&agrave;_redonner_au_club.pdf&quot;</strong>&nbsp;<br />et&nbsp;signer le <strong>coupon assurance</strong> et <strong>bulletin d&#39;inscription</strong>.</span></p><p style="text-align:center"><span style="font-family:Arial,Helvetica,sans-serif">Transmettre les documents au club avec votre paiement et certificat m&eacute;dical si besoin<br /><strong>(OBLIGATOIRE POUR TOUTE NOUVELLE INSCRIPTION).</strong></span></p><p style="text-align:center"><strong>TOUT DOSSIER INCOMPLET NE SERA PAS ACCEPT&Eacute; ET L&#39;INSCRIPTION NE SERA PAS VALID&Eacute;E</strong></p>', NULL, 0, 9, 1, 0],
            [20, 'Téléchargement essai', NULL, 7, 1, '<p style="text-align:center">Votre dossier d&#39;inscription vous a &eacute;t&eacute; envoy&eacute; par mail &agrave; l&#39;adresse {{ email_principal }}.</p><p style="text-align:center"><span style="font-family:Arial,Helvetica,sans-serif">Imprimez&nbsp;le fichier &quot;Docs_&agrave;_redonner_au_club.pdf&quot;&nbsp;et&nbsp;signer le <strong>coupon assurance</strong> et <strong>bulletin d&#39;inscription</strong>.</span></p><p style="text-align:center"><span style="font-family:Arial,Helvetica,sans-serif">Transmettre les documents au club.</span></p><p style="text-align:center">TOUT DOSSIER INCOMPLET NE SERA PAS ACCEPT&Eacute; ET L&#39;INSCRIPTION NE SERA PAS VALID&Eacute;E</p>', NULL, 1, 9, 0, 0],
        ];
